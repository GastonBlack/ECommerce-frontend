    ...
    return (
        ...
        >
            <div
                ...
                className="w-full max-w-3xl max-h-[85vh] rounded-2xl bg-white shadow-2xl border border-gray-200 overflow-hidden flex flex-col"
            >
                <div className="flex items-start justify-between px-6 py-5 border-b border-gray-200">
                    <div>
                        <h2 className="text-xl font-semibold">Detalle del pedido</h2>
                        <p className="text-sm text-gray-500">Pedido N° #{order.orderId}</p>
                    </div>
